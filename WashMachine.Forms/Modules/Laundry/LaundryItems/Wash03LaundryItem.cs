...
{
    public class Wash03LaundryItem : ILaundryItem
    {
        ...
        Timer timer;
        string lbInforName = $"lbInfor_{nameof(Wash03LaundryItem)}";

        public Wash03LaundryItem(FollowType _followType, Form parent)
        {
            mainForm = parent;
        ...
        public Control GetTemplate()
        {
            ...
            CardButtonRoundedUI cardButton = new CardButtonRoundedUI()
            {
                ...
                Name = $"CardButtonRoundedUI_{nameof(Wash03LaundryItem)}"
            };
            ...
            Label lbTitle = new Label
            {
                ...
                Name = $"Title_{nameof(Wash03LaundryItem)}"
            };
        ...
        private void ResetTemplate()
        {
            ...
            if (MachineService.IsRunCompleted(machine))
            {
                ...
                {
                    CardButtonRoundedUI cardButtonRounded = mainForm.Controls.Find($"CardButtonRoundedUI_{nameof(Wash03LaundryItem)}", true).First() as CardButtonRoundedUI;
                    cardButtonRounded.IsDisabled = false;
                    cardButtonRounded.Refresh();

                    Label lbTitle = mainForm.Controls.Find($"Title_{nameof(Wash03LaundryItem)}", true).First() as Label;
