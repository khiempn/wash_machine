...
namespace WashMachine.Forms.Modules.Laundry.LaundryItems
{
    public class Dryer02LaundryItem : ILaundryItem
    {
        ...
        Timer timer;
        string lbInforName = $"lbInfor_{nameof(Dryer02LaundryItem)}";
        ...
        {
            if (AppDbContext.Machine.Get(nameof(Dryer02LaundryItem)).IsRunning == 0)
            {
                ProgressUI progressUI = new ProgressUI();
                progressUI.SetParent(mainForm);
                progressUI.Show();
                LaundryDryerOption.LaundryOptionItems.Dryer02LaundryItem laundryItem = new LaundryDryerOption.LaundryOptionItems.Dryer02LaundryItem(null, mainForm);
        ...
        public Control GetTemplate()
        {
            ...
            CardButtonRoundedUI cardButton = new CardButtonRoundedUI()
            {
                ...
                Name = $"CardButtonRoundedUI_{nameof(Dryer02LaundryItem)}"
            };
            ...
            Label lbTitle = new Label
            {
                ...
                Name = $"Title_{nameof(Dryer02LaundryItem)}"
            };
        ...
        private void ResetTemplate()
        {
            ...
            if (MachineService.IsRunCompleted(machine))
            {
                ...
                {
                    CardButtonRoundedUI cardButtonRounded = mainForm.Controls.Find($"CardButtonRoundedUI_{nameof(Dryer02LaundryItem)}", true).First() as CardButtonRoundedUI;
                    cardButtonRounded.IsDisabled = false;
                    cardButtonRounded.Refresh();

                    Label lbTitle = mainForm.Controls.Find($"Title_{nameof(Dryer02LaundryItem)}", true).First() as Label;
