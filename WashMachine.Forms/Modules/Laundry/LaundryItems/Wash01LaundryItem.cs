...
{
    public class Wash01LaundryItem : ILaundryItem
    {
        public string Name => nameof(Wash01LaundryItem);
        Form mainForm;
        FollowType followType;
        Timer timer;
        string lbInforName = $"lbInfor_{nameof(Wash01LaundryItem)}";

        public Wash01LaundryItem(FollowType _followType, Form parent)
        {
            mainForm = parent;
        ...
        public Control GetTemplate()
        {
            ...
            CardButtonRoundedUI cardButton = new CardButtonRoundedUI()
            {
                ...
                Name = $"CardButtonRoundedUI_{nameof(Wash01LaundryItem)}"
            };
            ...
            Label lbTitle = new Label
            {
                ...
                Name = $"Title_{nameof(Wash01LaundryItem)}"
            };
        ...
        private void ResetTemplate()
        {
            ...
            if (MachineService.IsRunCompleted(machine))
            {
                ...
                {
                    CardButtonRoundedUI cardButtonRounded = mainForm.Controls.Find($"CardButtonRoundedUI_{nameof(Wash01LaundryItem)}", true).First() as CardButtonRoundedUI;
                    cardButtonRounded.IsDisabled = false;
                    cardButtonRounded.Refresh();

                    Label lbTitle = mainForm.Controls.Find($"Title_{nameof(Wash01LaundryItem)}", true).First() as Label;
