...
{
    public class Wash02LaundryItem : ILaundryItem
    {
        ...
        Timer timer;
        string lbInforName = $"lbInfor_{nameof(Wash02LaundryItem)}";

        public Wash02LaundryItem(FollowType _followType, Form parent)
        {
            mainForm = parent;
        ...
        public async void Click()
        {
            if (AppDbContext.Machine.Get(nameof(Wash02LaundryItem)).IsRunning == 0)
            {
                ...
                progressUI.Show();
                LaundryWashOption.LaundryOptionItems.Wash02LaundryItem laundryItem = new LaundryWashOption.LaundryOptionItems.Wash02LaundryItem(null, mainForm);
