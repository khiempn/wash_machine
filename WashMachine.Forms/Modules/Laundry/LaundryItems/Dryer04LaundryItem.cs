...
namespace WashMachine.Forms.Modules.Laundry.LaundryItems
{
    public class Dryer04LaundryItem : ILaundryItem
    {
        ...
        Timer timer;
        string lbInforName = $"lbInfor_{nameof(Dryer04LaundryItem)}";
        ...
        {
            if (AppDbContext.Machine.Get(nameof(Dryer04LaundryItem)).IsRunning == 0)
            {
                ProgressUI progressUI = new ProgressUI();
                progressUI.SetParent(mainForm);
                progressUI.Show();
                LaundryDryerOption.LaundryOptionItems.Dryer04LaundryItem laundryItem = new LaundryDryerOption.LaundryOptionItems.Dryer04LaundryItem(null, mainForm);
        ...
        public Control GetTemplate()
        {
            ...
            CardButtonRoundedUI cardButton = new CardButtonRoundedUI()
            {
                ...
                Name = $"CardButtonRoundedUI_{nameof(Dryer04LaundryItem)}"
            };
            ...
            Label lbTitle = new Label
            {
                ...
                Name = $"Title_{nameof(Dryer04LaundryItem)}"
            };
