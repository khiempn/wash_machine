...
namespace WashMachine.Forms.Modules.LaundryWashOption.LaundryOptionItems
{
    public class Wash01LaundryItem : ILaundryOptionItem
    {
        ...
        public string ImplementCommand { get; set; } = "01 06 01 27 00 01 F9 FD";
        ...
        {
            Logger.Log($"{nameof(Wash01LaundryItem)} MachineService_DataReceived {sender as string}");
        ...
        private void LoadConfig()
        {
            ...
            {
                {$"{nameof(Minute15TimeOptionItem)}", command.Wash01LaundryItem_Minute15TimeOptionItem },
                {$"{nameof(Minute30TimeOptionItem)}", command.Wash01LaundryItem_Minute30TimeOptionItem },
                {$"{nameof(Minute40TimeOptionItem)}", command.Wash01LaundryItem_Minute40TimeOptionItem },
                {$"{nameof(Minute45TimeOptionItem)}", command.Wash01LaundryItem_Minute45TimeOptionItem },
            };

            ImplementCommand = command.Wash01LaundryItem_ImplementCommand;
            StopCommand = command.Wash01LaundryItem_StopCommand;
            UnlockCommand = command.Wash01LaundryItem_UnlockCommand;
        }
        ...
        public async Task Stop()
        {
            await Task.Run(async () =>
            {
                Logger.Log($"{nameof(Wash01LaundryItem)} Step 1 STOP");
                LaundryWashOptionForm form = (LaundryWashOptionForm)mainForm;
        ...
        public async Task HealthCheck()
        {
            await Task.Run(async () =>
            {
                Logger.Log($"{nameof(Wash01LaundryItem)} Step 1 HealthCheck");
                AppConfigModel appConfig = Program.AppConfig;
                Logger.Log($"{nameof(Wash01LaundryItem)} Step 2 {JsonConvert.SerializeObject(appConfig)}");
