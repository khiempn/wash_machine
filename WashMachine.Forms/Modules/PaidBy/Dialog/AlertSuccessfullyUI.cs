...
namespace WashMachine.Forms.Modules.PaidBy.Dialog
{
    public class AlertSuccessfullyUI : Panel
    {
        ...
        public AlertSuccessfullyUI()
        {
            ...
            tblMain.RowStyles.Add(new RowStyle() { Height = 60, SizeType = SizeType.Absolute });
            tblMain.RowStyles.Add(new RowStyle() { Height = 90, SizeType = SizeType.Absolute });
            tblMain.RowStyles.Add(new RowStyle() { Height = 30, SizeType = SizeType.Percent });
            tblMain.RowStyles.Add(new RowStyle() { Height = 60, SizeType = SizeType.Absolute });
            tblMain.RowStyles.Add(new RowStyle() { Height = 20, SizeType = SizeType.Absolute });
            ...
            tblMain.Controls.Add(new Panel() { Name = "pnInvoice" }, 0, 2);
            ...
            tblMain.Controls.Add(new Label() { ForeColor = SystemColors.InfoText, Name = "lbTimeCounter", Text = "", Font = new Font(Font.FontFamily, 8f), }, 0, 4);
        ...
        public void SetOctopusInvoice(OrderModel orderModel)
        {
            ...
            FlowLayoutPanel flLines = new FlowLayoutPanel()
            {
                Dock = DockStyle.Fill,
            ...
            {
                var sizeText = TextRenderer.MeasureText(line, flLines.Font);

                flLines.Controls.Add(new Label()
                {
                    Text = line,
            ...
            pnInvoice.Controls.Add(flLines);
        }
