...
namespace WashMachine.Forms.Modules.Laundry.LaundryItems
{
    public class Dryer03LaundryItem : ILaundryItem
    {
        ...
        Timer timer;
        string lbInforName = $"lbInfor_{nameof(Dryer03LaundryItem)}";
        ...
        {
            if (AppDbContext.Machine.Get(nameof(Dryer03LaundryItem)).IsRunning == 0)
            {
                ProgressUI progressUI = new ProgressUI();
                progressUI.SetParent(mainForm);
                progressUI.Show();
                LaundryDryerOption.LaundryOptionItems.Dryer03LaundryItem laundryItem = new LaundryDryerOption.LaundryOptionItems.Dryer03LaundryItem(null, mainForm);
        ...
        public Control GetTemplate()
        {
            ...
            CardButtonRoundedUI cardButton = new CardButtonRoundedUI()
            {
                ...
                Name = $"CardButtonRoundedUI_{nameof(Dryer03LaundryItem)}"
            };
            ...
            Label lbTitle = new Label
            {
                ...
                Name = $"Title_{nameof(Dryer03LaundryItem)}"
            };
        ...
        private void ResetTemplate()
        {
            ...
            if (MachineService.IsRunCompleted(machine))
            {
                ...
                {
                    CardButtonRoundedUI cardButtonRounded = mainForm.Controls.Find($"CardButtonRoundedUI_{nameof(Dryer03LaundryItem)}", true).First() as CardButtonRoundedUI;
                    cardButtonRounded.IsDisabled = false;
                    cardButtonRounded.Refresh();

                    Label lbTitle = mainForm.Controls.Find($"Title_{nameof(Dryer03LaundryItem)}", true).First() as Label;
